            ...
            <!--- FORMULARIO -->
              ...
              <div id="tab2" class="tab-pane"> 
                <div class="span12" align="center">
                  <div class="widget-box">
                    <form class="form-horizontal" id="form-EjeTematico" action="#" class="j-forms" novalidate>
                      ...
                      <div class="controls-row">
                        <div class="span5">
                          ...
                          <div class="span 5">
                            ...
                            <div class="controls">
                              <select class="span6" id='facultad' name="facultad">
...
<script src="<?= base_url();?>application/views/eje_tematico/run_table.js" type="text/javascript"></script>  
