  ...
  <div id="content-header" style="margin-top: -20px;">
    <h1><center>Dedicación Docente</center></h1> <!-- Titulo General-->
  </div>
              ...
              <div id="tab1" class="tab-pane active">
                <div class="widget-box">
                  <div class="widget-title"> <span class="icon"><i class="icon-th"></i></span>
                    <h5>Lista de Dedicación Docentes Registrados</h5> <!-- Titulo de la lista-->
                  </div>
              ...
              <div id="tab2" class="tab-pane"> 
                <div class="span12" align="center">
                  <div class="widget-box"> <!-- Nombre del formulario-->
                    <form class="form-horizontal" id="form-DedicacionDocente" action="#" class="j-forms" novalidate>
                      <div class="widget-title"> <span class="icon"> <i class="icon-tag"></i> </span>
                        <h5>Dedicación Docente</h5><!-- titulo del formulario-->
                      </div>
...
<script src="<?= base_url();?>application/views/dedicacion_docente/run_table.js" type="text/javascript"></script>  
<!-- Lugar del script -->
