<div id="content" style="padding: 0px 13px;">
  <div id="content-header" style="margin-top: -20px;">
    <h1><center>Dedicación Docente</center></h1>
  </div>
              ...
              <div id="tab1" class="tab-pane active">
                <div class="widget-box">
                  <div class="widget-title"> <span class="icon"><i class="icon-th"></i></span>
                    <h5>Lista de Dedicación Docente Registrados</h5>
                  </div>
                  <div class="widget-content nopadding">
                    <table class="table table-bordered data-table" id="tabladeddocente">
                      <thead>
                        <tr>
                          <th>Nro</th>
                          <th>Descripción</th>
              ...
              <div id="tab2" class="tab-pane"> 
                <div class="span12" align="center">
                  <div class="widget-box">
                      ...
                      <div class="widget-content nopadding">
                        <form class="form-horizontal" id="ForDedicacionDocente">
                          <div class="control-group span4">
                            <label class="control-label">Nro :</label>
                            <div class="controls">
                              <input type="text" class="span11" name="ded_id" id="ded_id" disabled="" />
                            </div>
                          </div>
                          <div class="control-group span6">
                            <label class="control-label">Descripción :</label>
                            <div class="controls">
                              <input type="text" class="span12" placeholder="Ingrese Descripción" name="ded_descripcion" id="ded_descripcion" disabled="" />
                            </div>
                          </div><br><br><br>
                        </form>
                      </div><br>
