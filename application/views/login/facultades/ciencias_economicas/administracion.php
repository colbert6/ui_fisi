...
<html lang="en">
    ...
    <body>
        <div class="content">
            ...
            <div id="content" style="padding: 0px 13px;">
                <div id="content-header" style="margin-top: -20px;">
                    <h1><center>Escuela Academica Profesional de Administracion</center></h1>
                </div>
            ...
            <div class="row-fluid">
                <div id="footer" class="span12"> Administracion &copy; UNSM-T &nbsp; &nbsp; &nbsp;<b>Unidad de Investigacion</b> 
                </div>
            </div>
        </div>
        ...
        <script type="text/javascript" src="<?php echo base_url();?>librerias/canvasjs.min.js"></script>
          <script src="<?= base_url();?>application/views/login/facultades/ciencias_economicas/administracion.js" type="text/javascript"></script>
