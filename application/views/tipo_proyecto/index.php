<div id="content" style="padding: 0px 13px;">
  <div id="content-header" style="margin-top: -20px;">
    <h1><center>Tipo Proyecto</center></h1>
  </div>
              ...
              <div id="tab1" class="tab-pane active">
                <div class="widget-box">
                  ...
                  <div class="widget-content nopadding">
                    <table class="table table-bordered data-table" id="tablatipoproyecto">
                      <thead>
                        <tr>
                          <th>Nro</th>
                          <th>Descripción</th>
              ...
              <div id="tab2" class="tab-pane" align="center"> 
                <div class="span12" >
                  <div class="widget-box">
                      ...
                      <div class="widget-content nopadding">
                        <form class="form-horizontal" id="ForTipoProyecto">
                          <div class="control-group span4">
                            <label class="control-label">Nro :</label>
                            <div class="controls">
                              <input type="text" class="span11" id="tipro_id" name="tipro_id" disabled="" />
                            </div>
                          </div>
                          <div class="control-group span6">
                            <label class="control-label">Descripción :</label>
                            <div class="controls">
                              <input type="text" class="span12" id="tipro_descripcion" name="tipro_descripcion" disabled="" placeholder="Ingrese Descripción"/>
                            </div>
                          </div><br><br><br>
