              ...
              <div id="tab1" class="tab-pane active">
                <div class="widget-box">
                  <div class="widget-title"> <span class="icon"><i class="icon-th"></i></span>
                    <h5>Lista de Tipos de Proyectos Registrados</h5>
                  </div>
            ...
            <!--- FORMULARIO -->
              ...
              <div id="tab2" class="tab-pane"> 
                <div class="span12" align="center">
                  <div class="widget-box">
                    <form class="form-horizontal" id="form-TipoProyecto" action="#" class="j-forms" novalidate>
...
<script src="<?= base_url();?>application/views/tipo_proyecto/run_table.js" type="text/javascript"></script>  
