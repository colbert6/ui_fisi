...
cod_usu=$('#cod_usu').val() ;
    ...
    var table =$('#tab').DataTable( {
        ...
        "processing": true,
        "ajax": {
            "url": base_url+"proyecto/cargar_proyecto_evaluador/"+cod_usu,
            "type": "POST"
        },
        "columns": [
            { "data": "pro_id" },
    ...
    $('#tab tbody').on('click', 'td.evaluar-data', function () { //Agregar los datos correspondientes al modal-form
        var tr = $(this).closest('tr');
        var row = table.row( tr );

        window.location=base_url+"proyecto/evaluar_proyecto/"+row.data().pro_id;
    } );
