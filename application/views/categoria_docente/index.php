            ...
            <!--- FORMULARIO -->
              ...
              <div id="tab2" class="tab-pane"> 
                <div class="span12" align="center">
                  <div class="widget-box">
                    <form class="form-horizontal" id="form-CategoriaDocente" action="#" class="j-forms" novalidate>
                      <div class="widget-title"> <span class="icon"> <i class="icon-tag"></i> </span>
                        <h5>Categoria Docente</h5>
                      </div>
...
<script src="<?= base_url();?>application/views/categoria_docente/run_table.js" type="text/javascript"></script>  
